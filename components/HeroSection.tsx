        ...
        <div className="max-w-2xl">
          ...
          >
            {[
              ...
              <div key={i}>
                <span className="text-3xl font-extrabold text-gradient">{m.value}</span>
                <p className="text-[10px] text-text-muted font-mono uppercase mt-1 leading-tight">{m.label}</p>
              </div>
            ))}
          </motion.div>
